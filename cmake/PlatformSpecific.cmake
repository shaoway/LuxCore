...
if(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
  set(CMAKE_EXE_LINKER_FLAGS -Wl,--copy-dt-needed-entries,--disable-new-dtags,--version-script='${CMAKE_SOURCE_DIR}/cmake/exportmaps/linux_symbol_exports.map')
  set(CMAKE_SHARED_LINKER_FLAGS -Wl,--no-undefined)
  set(CMAKE_MODULE_LINKER_FLAGS -Wl,--no-undefined,--disable-new-dtags,--version-script='${CMAKE_SOURCE_DIR}/cmake/exportmaps/linux_symbol_exports.map')
...
# if LIBDIR not defined, we find ../lib/
