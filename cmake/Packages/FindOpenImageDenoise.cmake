...
#  OPENIMAGEDENOISE_ROOT, The base directory to search for OpenImageDenoise.
...
# If OPENIMAGEDENOISE_ROOT was defined in the environment, use it.
IF(NOT OPENIMAGEDENOISE_ROOT AND NOT $ENV{OPENIMAGEDENOISE_ROOT} STREQUAL "")
  SET(OPENIMAGEDENOISE_ROOT $ENV{OPENIMAGEDENOISE_ROOT})
ENDIF()

SET(_openimagedenoise_SEARCH_DIRS
  ${OPENIMAGEDENOISE_ROOT}
