...
void StatsWindow::Draw() {
	...
	if (ImGui::Begin(windowTitle.c_str(), &opened)) {
		...
		// GUI information
		if (ImGui::CollapsingHeader("GUI information", NULL, ImGuiTreeNodeFlags_None)) {
		...
		if (ImGui::CollapsingHeader("Rendering information", NULL, ImGuiTreeNodeFlags_None)) {
		...
		if (ImGui::CollapsingHeader("Intersection devices used", NULL, ImGuiTreeNodeFlags_None)) {
		...
		if (ImGui::CollapsingHeader("Intersection devices available", NULL, ImGuiTreeNodeFlags_None)) {
