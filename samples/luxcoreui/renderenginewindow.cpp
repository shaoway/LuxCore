...
void RenderEngineWindow::PathGUI(Properties &props, bool &modifiedProps) {
	...
	if (ImGui::CollapsingHeader("Path Bounces", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Russian Roulette", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Clamping", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Options", NULL, ImGuiTreeNodeFlags_None)) {
...
void RenderEngineWindow::TilePathGUI(Properties &props, bool &modifiedProps) {
	...
	if (ImGui::CollapsingHeader("Sampling", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Tiles", NULL, ImGuiTreeNodeFlags_None)) {
...
void RenderEngineWindow::PathOCLGUI(Properties &props, bool &modifiedProps) {
	...
	if (ImGui::CollapsingHeader("OpenCL Options", NULL, ImGuiTreeNodeFlags_None)) {
		bool bval;
		int ival;
...
void RenderEngineWindow::BiDirGUI(Properties &props, bool &modifiedProps) {
	...
	if (ImGui::CollapsingHeader("Path Depths", NULL, ImGuiTreeNodeFlags_None)) {
...
void RenderEngineWindow::ThreadsGUI(Properties &props, bool &modifiedProps) {
	if (ImGui::CollapsingHeader("Threads", NULL, ImGuiTreeNodeFlags_None)) {
...
bool RenderEngineWindow::DrawObjectGUI(Properties &props, bool &modifiedProps) {
	...
	if (currentRenderEngineType == "RTPATHOCL") {
		...
		if (ImGui::CollapsingHeader("Real Time", NULL, ImGuiTreeNodeFlags_None)) {
			// Preview phase
	...
	if (currentRenderEngineType == "BIDIRVMCPU") {
		...
		if (ImGui::CollapsingHeader("BiDirVM Options", NULL, ImGuiTreeNodeFlags_None)) {
			float fval;
			int ival;
	...
	if (currentRenderEngineType == "LIGHTCPU") {
		...
		if (ImGui::CollapsingHeader("Path Depth", NULL, ImGuiTreeNodeFlags_None)) {
			ival = props.Get("path.pathdepth.total").Get<int>();
			if (ImGui::InputInt("Maximum light path recursion depth", &ival)) {
				props.Set(Property("path.pathdepth.total")(ival));
				modifiedProps = true;
