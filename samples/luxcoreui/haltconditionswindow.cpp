...
bool HaltConditionsWindow::DrawObjectGUI(Properties &props, bool &modifiedProps) {
	if (ImGui::CollapsingHeader("Halt threshold", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Halt time", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Halt samples/pixel", NULL, ImGuiTreeNodeFlags_None)) {
