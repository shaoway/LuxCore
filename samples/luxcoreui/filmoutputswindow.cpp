...
bool FilmOutputsWindow::DrawObjectGUI(Properties &props, bool &modifiedProps) {
	...
	if (ImGui::CollapsingHeader("New Film output", NULL, ImGuiTreeNodeFlags_None)) {
		// Film output name
	...
	if (ImGui::CollapsingHeader("Current Film output(s)", NULL, ImGuiTreeNodeFlags_None)) {
	...
	if (ImGui::CollapsingHeader("Current Film channel(s)", NULL, ImGuiTreeNodeFlags_None)) {
